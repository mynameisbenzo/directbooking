...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <button class="nav-link collapsed" data-bs-toggle="collapse" data-bs-target="#collapseTwo"
            ...
            <li class="nav-item">
                <button class="nav-link collapsed" data-bs-toggle="collapse" data-bs-target="#collapseUtilities"
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                <button class="nav-link collapsed" data-bs-toggle="collapse" data-bs-target="#collapsePages"
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <button class="dropdown-item text-center small text-gray-500">Show All Alerts</button>
                            </div>
                        </li>
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <button class="dropdown-item text-center small text-gray-500">Read More Messages</button>
                            </div>
                        </li>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <button class="nav-link dropdown-toggle" id="userDropdown"
                                ...
                                <img alt="boingo" class="img-profile rounded-circle"
